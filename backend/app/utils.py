...
def generate_recipe_code(
    ...
    return (
        f"REC-{year}-{count:04d}"
    )


# ============================================================
# RECETA COMPLETA PARA API
# ============================================================
...
def recipe_to_out(
    ...
    if getattr(
        ...
        try:
            ...
            dictionary_suggestions = json.loads(
